...
int zns_read_request(int fd, const void * read_data, int nblocks, __u64 slba);
int zns_read(struct zns_share_info * zonelist, const void * read_data, int data_size, int zone_number, __u64 offset);
